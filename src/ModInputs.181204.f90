...
!! EddyVelocity Terms
  ...
  logical :: UseImprovedElectronThermalConduction = .false.
  real    :: ElectronThermalConduction_d1 = 0.0
  real    :: ElectronThermalConduction_d2 = 0.0
  real    :: ElectronThermalConduction_d3 = 0.0
  real    :: ElectronThermalConduction_d4 = 0.0
  real    :: ElectronThermalConduction_d5 = 0.0
  real    :: ElectronThermalConduction_dt = 1.0

  real :: k10O = 3.6e-17

  logical :: UseOplusFlux = .false.
  real    :: PhiDO        = 2.0e12
  real    :: PhiNO        = -2.0e12
